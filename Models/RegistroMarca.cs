...
namespace GISMVC.Models
{
    ...
    public class Solicitud
    {
        ...
        public Solicitud(int _id, string _nombre, int _empresa, int _pais, int _tipo, string _usuario,int _tipo_solicitud, int _aplicado)
        {
            id = _id;
            nombre = _nombre;
            empresa = _empresa;
        ...
        public static List<Solicitud> ListMarcaToSolicitud(List<Marca> lista)
        {
            ...
            try
            {
                ...
                {
                    Solicitud solicitud = new Solicitud(item.id, item.nombre, item.empresa, item.pais, 1, item.usuario,item.tipo_solicitud, item.aplicado);
                    list.Add(solicitud);
                }
            }
            catch (Exception ex)
        ...
        public static List<Solicitud> ListAvisoComercialToSolicitud(List<AvisoComercial> lista)
        {
            ...
            try
            {
                foreach (var item in lista)
                {
                    Solicitud solicitud = new Solicitud(item.id, item.nombre, item.empresa, item.pais, 2, item.usuario, item.tipo_solicitud, item.aplicado);
                    list.Add(solicitud);
                }
            }
            catch (Exception ex)
        ...
        public static List<Solicitud> ListPatenteToSolicitud(List<Patente> lista)
        {
            ...
            try
            {
                foreach (var item in lista)
                {
                    Solicitud solicitud = new Solicitud(item.id, item.nombre, item.empresa, item.pais, 3, item.usuario, item.tipo_solicitud, item.aplicado);
                    list.Add(solicitud);
                }
            }
            catch (Exception ex)
        ...
        public static List<Solicitud> ListDisenoIndustrialToSolicitud(List<DisenoIndustrial> lista)
        {
            ...
            try
            {
                foreach (var item in lista)
                {
                    Solicitud solicitud = new Solicitud(item.id, item.nombre, item.empresa, item.pais, 4, item.usuario, item.tipo_solicitud, item.aplicado);
                    list.Add(solicitud);
                }
            }
            catch (Exception ex)
        ...
        public static List<Solicitud> ListModeloUtilidadToSolicitud(List<ModeloUtilidad> lista)
        {
            ...
            try
            {
                foreach (var item in lista)
                {
                    Solicitud solicitud = new Solicitud(item.id, item.nombre, item.empresa, item.pais, 5, item.usuario, item.tipo_solicitud, item.aplicado);
                    list.Add(solicitud);
                }
            }
            catch (Exception ex)
        ...
        public static List<Solicitud> ListModeloIndustrialToSolicitud(List<ModeloIndustrial> lista)
        {
            ...
            try
            {
                foreach (var item in lista)
                {
                    Solicitud solicitud = new Solicitud(item.id, item.nombre, item.empresa, item.pais, 6, item.usuario, item.tipo_solicitud, item.aplicado);
                    list.Add(solicitud);
                }
            }
            catch (Exception ex)
        ...
        public static List<Solicitud> ListObraToSolicitud(List<Obra> lista)
        {
            ...
            try
            {
                foreach (var item in lista)
                {
                    Solicitud solicitud = new Solicitud(item.id, item.nombre, item.empresa, item.pais, 7, item.usuario, item.tipo_solicitud, item.aplicado);
                    list.Add(solicitud);
                }
            }
            catch (Exception ex)
