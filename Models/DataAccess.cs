...
namespace GISMVC.Models
{
    public class DataAccess
    {
        ...
        public Boolean Reg_UsuarioHistorial(AspNetUsers modelo,out DataTable dt, out String msgError)
        {
            bool boolProcess = true;
            dt = new DataTable();
            msgError = string.Empty;
        ...
        public Boolean Upd_UsuarioActivo(AspNetUsers modelo, out DataTable dt, out String msgError)
        {
            ...
            try
            {
                ...
                int i = 0;
                @params[0] = new SqlParameter("@id", modelo.id);
                @params[1] = new SqlParameter("@usuario", modelo.usuariolg);
                @params[2] = new SqlParameter("@usuario_nombre", modelo.usuariolg_name);
                i++;
        ...
        public Boolean Password_UsuarioHistorial(AspNetUsers modelo, out DataTable dt, out String msgError)
        {
            bool boolProcess = true;
            dt = new DataTable();
            msgError = string.Empty;
        ...
        public Boolean INS_NegocioPI(NegocioPI modelo, out DataTable dt, out String msgError)
        {
            ...
            try
            {
                ...
                @params[i] = new SqlParameter("@rfc", modelo.rfc); i++;
                @params[i] = new SqlParameter("@usuario", modelo.usuario); i++;
                @params[i] = new SqlParameter("@usuario_nombre", modelo.usuario_nombre); i++;
                i++;
        ...
        public Boolean INS_ConvenioLicencia(ConvenioLicencia modelo, out DataTable dt, out String msgError)
        {
            ...
            try
            {
                SqlParameter[] @params = new SqlParameter[32];
        ...
        public Boolean UPD_ConvenioLicencia(ConvenioLicencia modelo, out DataTable dt, out String msgError)
        {
            ...
            try
            {
                SqlParameter[] @params = new SqlParameter[33];
        ...
        public Boolean Cons_proc_HistorialMovimientos(out DataTable dt, out String msgError,int modulo,int tipo,string usuario, int activo = -1)
        {
            ...
            try
            {
                ...
                if (!bd.ExecuteProcedure(conexion, "Cons_proc_HistorialMovimientos", @params, out dt, 1000))
                {
                    boolProcess = false;
                    msgError = bd._error.ToString();
                }
