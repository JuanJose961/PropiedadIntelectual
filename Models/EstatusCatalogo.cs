...
namespace GISMVC.Models
{
    public class EstatusCatalogo
    {
        ...
        public static EstatusCatalogo GetById(int id)
        {
            ...
            try
            {
                ...
                var errores = "";
                if (da.Cons_EstatusCatalogoById(id, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        int idx = 0;
        ...
        public static EstatusCatalogo GetFromUsuario(string id)
        {
            EstatusCatalogo res = new EstatusCatalogo();
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.Cons_EstatusCatalogoFromUsuario(id, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        int idx = 0;
        ...
        public static List<EstatusCatalogo> Get(int activo = -1)
        {
            List<EstatusCatalogo> res = new List<EstatusCatalogo>();
            try
            {
                DataAccess da = new DataAccess();
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.Cons_EstatusCatalogo(out dt, out errores, activo))
                {
                    if (dt.Rows.Count > 0)
                    {
        ...
        public static RespuestaFormato Crear(EstatusCatalogo modelo)
        {
            ...
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.INS_EstatusCatalogo(modelo, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        var row = dt.Rows[0];
        ...
        public static RespuestaFormato Actualizar(EstatusCatalogo modelo)
        {
            RespuestaFormato res = new RespuestaFormato();
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.UPD_EstatusCatalogo(modelo, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        var row = dt.Rows[0];
        ...
        public static RespuestaFormato ActualizarActivo(EstatusCatalogo modelo)
        {
            RespuestaFormato res = new RespuestaFormato();
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.UPD_EstatusCatalogo_Activo(modelo, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        var row = dt.Rows[0];
