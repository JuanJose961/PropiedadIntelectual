    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (jsonResponse.flag != false) {
                ...
                $("#uu_02").val(catalogo_actual.numero_registro);
                $("#uu_03").val(catalogo_actual.numero_expediente);
                $("#uu_07").val(catalogo_actual.clase).trigger("change");
                $("#uu_08").val(catalogo_actual.pais).trigger("change");
...
function Confirma01() {
    if (ValidaUpdate01() != false) {
        ...
        setTimeout(function () {
            ...
            catalogo_actual.licenciatario = parseInt($("#uu_04 option:selected").val());
...
function GuardarArchivo(input, tipo) {
    ...
    $.ajax({
        url: hosturl + 'api/Archivos/LicenciaSaveFile',
        type: 'POST',
        data: formData,
