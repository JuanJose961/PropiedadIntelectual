...
function Editar(id) {
    ...
    var sended_url = services_url + "SelectModeloIndustrialById";
    $.ajax({
        type: "POST",
        url: sended_url,
...
function Confirma01() {
    if (ValidaUpdate01() != false) {
        if (catalogo_actual.id == 0) {
            catalogo_actual.tipo_solicitud = 6;
            catalogo_actual.tipo_solicitud_nombre = "Modelo Industrial";
        }
        ...
        var sended_url = services_url + "AddModeloIndustrial";
        if (catalogo_actual.id > 0) {
            sended_url = services_url + "UpdateModeloIndustrial";
        }
...
function ConfirmaEliminar01() {
    ...
    var sended_url = services_url + "UpdateModeloIndustrialActivo";
    $.ajax({
        type: "POST",
        url: sended_url,
        data: JSON.stringify(catalogo_actual),
