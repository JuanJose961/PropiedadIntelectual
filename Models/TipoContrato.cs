...
namespace GISMVC.Models
{
    ...
    public class TipoContrato
    {
        ...
        public static TipoContrato GetById(int id)
        {
            TipoContrato res = new TipoContrato();
            try
            {
                ...
                var errores = "";
                if (da.Cons_TipoContratoById(id, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        int idx = 0;
        ...
        public static TipoContrato GetFromUsuario(string id)
        {
            TipoContrato res = new TipoContrato();
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.Cons_TipoContratoFromUsuario(id, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        int idx = 0;
        ...
        public static List<TipoContrato> Get(int activo = -1)
        {
            ...
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.Cons_TipoContrato(out dt, out errores, activo))
                {
                    if (dt.Rows.Count > 0)
                    {
        ...
        public static RespuestaFormato Crear(TipoContrato modelo)
        {
            ...
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.INS_TipoContrato(modelo, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        var row = dt.Rows[0];
        ...
        public static RespuestaFormato Actualizar(TipoContrato modelo)
        {
            RespuestaFormato res = new RespuestaFormato();
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.UPD_TipoContrato(modelo, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        var row = dt.Rows[0];
        ...
        public static RespuestaFormato ActualizarActivo(TipoContrato modelo)
        {
            RespuestaFormato res = new RespuestaFormato();
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.UPD_TipoContrato_Activo(modelo, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        var row = dt.Rows[0];
