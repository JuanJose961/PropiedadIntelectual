...
function Editar(id) {
    ...
    var sended_url = services_url + "SelectMarcaById";
    $.ajax({
        type: "POST",
        url: sended_url,
...
function Confirma01() {
    if (ValidaUpdate01() != false) {
        if (catalogo_actual.id == 0) {
            catalogo_actual.tipo_solicitud = 1;
            catalogo_actual.tipo_solicitud_nombre = "Marca";
        }
        ...
        var sended_url = services_url + "AddMarca";
        if (catalogo_actual.id > 0) {
            sended_url = services_url + "UpdateMarca";
        }
...
function ConfirmaEliminar01() {
    ...
    var sended_url = services_url + "UpdateMarcaActivo";
    $.ajax({
        type: "POST",
        url: sended_url,
        data: JSON.stringify(catalogo_actual),
