...
namespace GISMVC.Models
{
    public class Clase
    {
        ...
        public static Clase GetById(int id)
        {
            Clase res = new Clase();
            try
            {
                ...
                var errores = "";
                if (da.Cons_ClaseById(id, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        int idx = 0;
        ...
        public static Clase GetFromUsuario(string id)
        {
            Clase res = new Clase();
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.Cons_ClaseFromUsuario(id, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        int idx = 0;
        ...
        public static List<Clase> Get(int activo = -1)
        {
            List<Clase> res = new List<Clase>();
            try
            {
                DataAccess da = new DataAccess();
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.Cons_Clase(out dt, out errores, activo))
                {
                    if (dt.Rows.Count > 0)
                    {
        ...
        public static RespuestaFormato Crear(Clase modelo)
        {
            ...
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.INS_Clase(modelo, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        var row = dt.Rows[0];
        ...
        public static RespuestaFormato Actualizar(Clase modelo)
        {
            RespuestaFormato res = new RespuestaFormato();
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.UPD_Clase(modelo, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        var row = dt.Rows[0];
        ...
        public static RespuestaFormato ActualizarActivo(Clase modelo)
        {
            RespuestaFormato res = new RespuestaFormato();
            try
            {
                ...
                var dt = new System.Data.DataTable();
                var errores = "";
                if (da.UPD_Clase_Activo(modelo, out dt, out errores))
                {
                    if (dt.Rows.Count > 0)
                    {
                        var row = dt.Rows[0];
